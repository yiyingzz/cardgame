...
// >>>>>>>>>>> PUT EVERYTHING IN NAMESPACE OBJ !!!!!!!!!!!!!!!! <<<<
// ^^^^^^^^^^^^^^^^^^^^^^^^^^^
// 2. document ready
// 3. further styling
// 4. card back - redo design
// 5. FIX FUNCTION NAMES TO NAMESPACE OBJ
// 6. optional: animation effects on cards (maybe use git)


// NAMESPACE OBJECT FIRST
const cardGame = {};
...
// function to make all cards unable to be clicked on after guessing right or wrong
